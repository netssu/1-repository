...
local MOUSE_ENTER_SIZE = 1.04
local MOUSE_ENTER_DURATION = .1
local CLICK_SIZE = 1.12
...
function module.SetUp(button)
	button = button:FindFirstChild('Internal') or button
	...
	if button.Name == 'Internal' then
		selectButton = button.Parent
	else
		selectButton = button
	end
