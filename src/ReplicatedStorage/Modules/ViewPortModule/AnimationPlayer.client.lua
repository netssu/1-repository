...
if script.Parent:FindFirstChild('Animations') and script.Parent:FindFirstChild('Humanoid') then	
	...
	local AnimTrack: AnimationTrack = Animator:LoadAnimation(script.Parent.Animations.Idle)
	AnimTrack:Play()
	AnimTrack:AdjustSpeed(0) -- note from ace: because we have SO MANY VIEWPORTS, like 200 in inventory etc i suggest disabling anims completely
